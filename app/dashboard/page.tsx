...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)", fontFamily: "'DM Sans', sans-serif", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 40px", position: "relative", overflow: "hidden" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-logo { font-family: 'Playfair Display', serif; font-size: 1.1rem; font-weight: 800; color: var(--text); letter-spacing: -0.5px; }
        ...
        .user-name { font-family: 'DM Mono', monospace; font-size: 0.72rem; color: var(--text-muted); }

        .logout-btn {
          display: flex; align-items: center; gap: 6px;
          background: transparent; border: 1px solid var(--danger-border);
          border-radius: 8px; padding: 7px 14px;
          color: var(--danger-text); font-family: 'DM Mono', monospace;
        ...
        .eyebrow {
          ...
          text-transform: uppercase; color: #4f46e5; background: var(--accent-bg);
          border: 1px solid var(--accent-border); padding: 5px 14px; border-radius: 4px;
          margin-bottom: 28px; display: inline-block;
        }

        .hero-title { font-family: 'Playfair Display', serif; font-size: clamp(2.6rem, 5vw, 4rem); font-weight: 800; color: var(--text); letter-spacing: -2px; line-height: 1.05; text-align: center; margin-bottom: 20px; }
        .hero-title span { color: #4f46e5; }

        .hero-sub { font-size: 0.95rem; color: var(--text-muted); text-align: center; max-width: 500px; line-height: 1.75; margin-bottom: 52px; font-family: 'DM Sans', sans-serif; }

        .cards-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; width: 100%; max-width: 740px; position: relative; z-index: 1; }
        ...
        .nav-card:hover { border-color: var(--accent-border); box-shadow: var(--shadow-md); transform: translateY(-3px); }

        .card-icon { width: 42px; height: 42px; background: var(--accent-bg); border: 1px solid var(--accent-border); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #4f46e5; flex-shrink: 0; }
        .card-label { font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 800; color: var(--text); line-height: 1.25; margin-bottom: 6px; }
        .card-sub { font-family: 'DM Sans', sans-serif; font-size: 0.78rem; color: var(--text-faint); line-height: 1.55; }

        .card-arrow { display: flex; align-items: center; justify-content: space-between; margin-top: auto; padding-top: 4px; }
        .arrow-label { font-family: 'DM Mono', monospace; font-size: 0.6rem; letter-spacing: 2px; text-transform: uppercase; color: var(--text-faint); transition: color 0.2s; }
        .nav-card:hover .arrow-label { color: #4f46e5; }
        .arrow-icon { color: var(--text-faint); transition: color 0.2s, transform 0.2s; }
        .nav-card:hover .arrow-icon { color: #4f46e5; transform: translateX(3px); }

        .footer-note { margin-top: 52px; font-family: 'DM Mono', monospace; font-size: 0.6rem; letter-spacing: 2px; text-transform: uppercase; color: var(--text-faint); position: relative; z-index: 1; }
      `}</style>
